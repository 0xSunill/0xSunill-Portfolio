...
type BallProps = { name: string };

const Ball = ({ name }: BallProps) => {
  const url = `/assets/tech/${name}.png`;
...
type BallCanvasProps = { name: string };

const BallCanvas = ({ name }: BallCanvasProps) => {
  return (
